...
public class SendEmailUtil {
    ...
    //发件人邮箱
    public static String myEmailAccount = "vinverre@163.com";
    //授权码 （为了安全，而非邮箱密码）
    public static String myEmailPassword = "MIQWMWOLYYTAZWYN";
    ...
    public static void sendMail(String email,String title,String content){
        ...
        try {
            ...
            // 3. 创建一封邮件
            MimeMessage message = createMimeMessage(session, myEmailAccount, email,title,content);
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String title,String content) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "vinverre", "UTF-8"));
